...
#                 16 17 18
#
# Cell IDs are therefore fixed as:
#   TOP    1..9,   BOTTOM 10..18, LEFT 19..27,
#   FRONT 28..36,  RIGHT 37..45, BACK 46..54.
#
# The lookup is the source of truth for the generator. It contains both
# same-face neighbours and the folded edge neighbours implied by the net.
# Every cell has exactly four unique neighbours and every relationship is
# reciprocal.
CELL_ADJACENCY = {
    1: (2, 4, 27, 34),
    2: (1, 3, 5, 35),
